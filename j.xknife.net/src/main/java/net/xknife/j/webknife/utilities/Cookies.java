...
public interface Cookies
{
	 ...
	 * 
	 * @param name
	 *            cookie名称，必须是ascii码和数字，其他会抛错 RFC2019
	 * @param value
	 *            cookie的值
	 */
	...
	public static class DefaultCookies implements Cookies
	{
		...
		@Inject
		public DefaultCookies(final BeatContext beat)
		{
		...
		@Override
		public void add(final String name, final String value, final int cookieMaxAge)
		{
			Cookie cookie = new Cookie(name, value);
			// 设置有效日期
