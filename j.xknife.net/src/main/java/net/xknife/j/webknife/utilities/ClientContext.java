package net.xknife.j.webknife.utilities;
...
/**
 * 获得客户端信息 包括浏览器端所发送给服务器的所有信息
 * 
 * 其中， 1. 通过和nginx/apache等反向代理合作，可以安全获得客户端ip
 * 
 * @see #getAddress()
 * @see ReverseProxy 2. 可以获得url上的参数即 http://bj.58.com/?paramname=value
 * @see #queryString(String) 3. form可以获得post的form中的参数
 * @see #form(String) 4. 方便获得上传文件
...
public interface ClientContext
{
	...
	/**
	 * 获得url中的参数 其中可以通过注入可以安全获得参赛防止 xss或sql注入等
	 * 
	...
	/**
	 * 获得post中的参数 其中可以通过注入可以安全获得参赛防止 xss或sql注入等
	 * 
	 * @see SafeParameter#encoding(String)
	 * 
	 * @param name
	...
	/**
	 * 获得post中的参数，不包括文件 其中可以通过注入可以安全获得参赛防止 xss或sql注入等
	 * 
	 * @see SafeParameter
	 * 
	 * @return 所有post中的参数集合
	...
	//
	// @Inject
	// public DefaultClientContext(final HttpServletRequest request, final ReverseProxy reverseProxy)
	// {
	...
	//
	// @Override
	// public String queryString(final String name)
	// {
	// return request.queryString(name);
	// }
	//
	// @Override
	// public Collection<String> queryStrings(final String name)
	// {
	// return request.queryStrings().get(name);
	// }
	//
	// @Override
	// public String form(final String name)
	// {
	// return request.form(name);
	// }
	//
	// @Override
	// public Collection<String> forms(final String name)
	// {
	...
	//
	// @Override
	// public Upload getUpload(final String name)
	// {
