...
{
    public partial class ColorPickerDialog : System.Windows.Forms.Form
    {
            ...
            switch (_PrimAttrib)
            {
                ...
                case PrimaryAttrib.Hue:
                    colorPanel.SetupXYGradient(
                        Color.White,
                        ColorExtension.ColorFromHSV(_SelectedColor.h, 1.0f, 1.0f),
                        Color.Black,
                        Color.Transparent);
                    break;
                case PrimaryAttrib.Saturation:
            ...
            switch (_PrimAttrib)
            {
                ...
                case PrimaryAttrib.Saturation:
                    colorSlider.SetupGradient(
                        ColorExtension.ColorFromHSV(_SelectedColor.h, 0.0f, _SelectedColor.v),
                        ColorExtension.ColorFromHSV(_SelectedColor.h, 1.0f, _SelectedColor.v));
                    break;
                case PrimaryAttrib.Brightness:
                    colorSlider.SetupGradient(
                        ColorExtension.ColorFromHSV(_SelectedColor.h, _SelectedColor.s, 0.0f),
                        ColorExtension.ColorFromHSV(_SelectedColor.h, _SelectedColor.s, 1.0f));
                    break;
                case PrimaryAttrib.Red:
                    tmp = _SelectedColor.ToColor();
                    colorSlider.SetupGradient(
        ...
        private struct InternalColor
        {
            ...
            {
                return Color.FromArgb((int) Math.Round(a * 255.0f), ColorExtension.ColorFromHSV(h, s, v));
            }
        }
    }
}