...
namespace Jeelu.Billboard.Server
{
    internal static partial class Service
    {
        ...
        internal static partial class Option
        {
            ...
            {
                if (System.IO.File.Exists(_OptionFile))
                {
                    System.IO.File.Delete(_OptionFile);///因虽文件存在，但xml读取出错，故将其删除。
                }
                FileStream fs = System.IO.File.Open(_OptionFile, FileMode.Create);
