...
namespace Jeelu.Win
{
    ...
    public class AutoLayoutPanelAttribute : Attribute
    {
        ...
        private MainControlType _MainControlType = MainControlType.TextBox;

        /// <summary>
        /// 获取主控件类型, 默认一般的TextBox
        /// </summary>
        [Category("! important"), Description("获取主控件类型, 默认一般的TextBox")]
        public MainControlType MainControlType
        {
        ...
        private FileSelectFilter _FileSelecterControlFilter = FileSelectFilter.All;
        ...
        public FileSelectFilter FileSelecterControlFilter
        {
        ...
        public override string ToString()
        {
            ...
            if (_MainControlType != MainControlType.TextBox)
            {
