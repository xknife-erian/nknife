            ...
            ListViewItem item = new ListViewItem(new string[]
                {
                    ...
                    recode.Tags.Get("White","").ToString(),
                    recode.Tags.Get("WhiteElo","").ToString(),
                    recode.Tags.Get("Black","").ToString(),
                    recode.Tags.Get("BlackElo","").ToString(),
                    recode.Tags.Get("Event","").ToString(),
                    recode.Tags.Get("Site","").ToString(),
                    recode.Tags.Get("Result","").ToString(),
                    recode.Tags.Get("ECO","").ToString(),
                    recode.Tags.Get("Date","").ToString(),
                    recode.Tags.Get("PlyCount", recode.Items.Count.ToString()),
                });
            item.Tag = recode;
            this.Items.Add(item);
            this.Number++;
