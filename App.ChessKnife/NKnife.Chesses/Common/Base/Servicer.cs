...
namespace Gean.Module.Chess
{
    internal static class Servicer
    {
        static Servicer()
        {
            ...
            regexs.Add(Pair<AsStep, Regex>.Build(AsStep.As_Rbe1, new Regex(@"^[RNBQK][a-h][a-h][1-8]$", RegexOptions.Compiled)));
            regexs.Add(Pair<AsStep, Regex>.Build(AsStep.As_N1c3, new Regex(@"^[RNBQK][1-8][a-h][1-8]$", RegexOptions.Compiled)));
            regexs.Add(Pair<AsStep, Regex>.Build(AsStep.As_hxg6, new Regex(@"^[a-h]x[a-h][1-8]$", RegexOptions.Compiled)));
            regexs.Add(Pair<AsStep, Regex>.Build(AsStep.As_O_O, new Regex(@"^[O]-[O]$", RegexOptions.Compiled)));
            regexs.Add(Pair<AsStep, Regex>.Build(AsStep.As_O_O_O, new Regex(@"^[O]-[O]-[O]$", RegexOptions.Compiled)));
            regexs.Add(Pair<AsStep, Regex>.Build(AsStep.As_Ngxf6, new Regex(@"^[RNBQK][a-h]x[a-h][1-8]$", RegexOptions.Compiled)));
            regexs.Add(Pair<AsStep, Regex>.Build(AsStep.As_R8xf5, new Regex(@"^[RNBQK][1-8]x[a-h][1-8]$", RegexOptions.Compiled)));
            regexs.Add(Pair<AsStep, Regex>.Build(AsStep.As_e8_Q, new Regex(@"^[a-h][1-8]=[RNBQ]$", RegexOptions.Compiled)));
            regexs.Add(Pair<AsStep, Regex>.Build(AsStep.As_exf8_Q, new Regex(@"^[a-h]x[a-h][1-8]=[RNBQ]$", RegexOptions.Compiled)));
