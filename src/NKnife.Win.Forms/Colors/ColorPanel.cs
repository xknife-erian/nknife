...
namespace NKnife.Win.Forms.Colors
{
    public class ColorPanel : Control
    {
        ...
        public void SetupHueBrightnessGradient(float saturation = 1.0f, int accuracy = 256)
        {
            ...
            blendX.Colors = new[]
            {
                ColorExtension.ColorFromHSV(0.0f, saturation, 1.0f),
                ColorExtension.ColorFromHSV(1.0f / 6.0f, saturation, 1.0f),
                ColorExtension.ColorFromHSV(2.0f / 6.0f, saturation, 1.0f),
                ColorExtension.ColorFromHSV(3.0f / 6.0f, saturation, 1.0f),
                ColorExtension.ColorFromHSV(4.0f / 6.0f, saturation, 1.0f),
                ColorExtension.ColorFromHSV(5.0f / 6.0f, saturation, 1.0f),
                ColorExtension.ColorFromHSV(1.0f, saturation, 1.0f)
            };
        ...
        public void SetupHueSaturationGradient(float brightness = 1.0f, int accuracy = 256)
        {
            ...
            blendX.Colors = new[]
            {
                ColorExtension.ColorFromHSV(0.0f, 1.0f, brightness),
                ColorExtension.ColorFromHSV(1.0f / 6.0f, 1.0f, brightness),
                ColorExtension.ColorFromHSV(2.0f / 6.0f, 1.0f, brightness),
                ColorExtension.ColorFromHSV(3.0f / 6.0f, 1.0f, brightness),
                ColorExtension.ColorFromHSV(4.0f / 6.0f, 1.0f, brightness),
                ColorExtension.ColorFromHSV(5.0f / 6.0f, 1.0f, brightness),
                ColorExtension.ColorFromHSV(1.0f, 1.0f, brightness)
            };
            blendX.Positions = new[]
            {
                0.0f,
