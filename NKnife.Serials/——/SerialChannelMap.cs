...
using NKnife.Serials;

namespace NKnife.Channels.Serial
{
    public class SerialChannelMap : IDictionary<ushort, Tuple<SerialConfig, SerialChannel>>
    {
        ...
        #region Implementation of ICollection<KeyValueTuple<ushort,Tuple<SerialConfig,SerialChannel>>>
