...
namespace NKnife.Wrapper
{
    ...
    /// </summary>
    public class WindowServiceFormLoader
    {
        private static readonly ILog _logger = LogManager.GetLogger<WindowServiceFormLoader>();
        ...
        {
            WindowServiceFormLoader.Open(EventLog);
