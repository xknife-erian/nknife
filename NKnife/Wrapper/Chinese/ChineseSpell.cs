...
namespace Gean.Wrapper.Chinese
{
    ...
    public sealed class ChineseSpell
    {
        ...
        public static string GetStringSpell(string chs, string separator, bool initialCap)
        {
            ...
            // 例外词组
            foreach (var item in ChineseSpell.SpecialPhrase)
            {
                chs = chs.Replace(item.Key.ToString(), string.Format(" {0} ", item.Value.ToString().Replace(" ", separator)));
            }
        ...
        {
            return ChineseSpell.GetStringSpell(chs, separator, false);
        }
        ...
        {
            return ChineseSpell.GetStringSpell(chs, "", initialCap);
        }
        ...
        {
            return ChineseSpell.GetStringSpell(chs, "");
        }
        ...
        static public string GetStringFirstSpell(string strText)
        {
        ...
        static public string GetCharFirstSpell(string cnChar)
        {
            ...
            if (arrCN.Length > 1)
            {
                ...
                int code = (area << 8) + pos;
                int[] areacode = { 45217, 3, 45761, 46318, 46826, 47010, 47297, 47614, 48119, 48119, 49062, 49324, 49896, 50371, 50614, 50622, 50906, 51387, 51446, 52218, 52698, 52698, 52698, 52980, 53689, 54481 };
                for (int i = 0; i < 26; i++)
                {
                    int max = 55290;
