...
namespace NKnife.Wrapper
{
    ...
    public class SystemDateTime
    {
        ...
        private static extern Boolean SetLocalTime(ref SysDateTime st);

        [DllImport("kernel32.dll")]
        public static extern void GetLocalTime(ref SysDateTime lpSystemTime);
