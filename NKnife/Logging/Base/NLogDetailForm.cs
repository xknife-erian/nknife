...
namespace NKnife.Logging.Base
{
    /// <summary>日志详细信息展现窗体
    /// </summary>
    public sealed class NLogDetailForm : Form
    {
        public static void Show(LogEventInfo info)
        {
            var form = DI.Get<NLogDetailForm>();
            form.Size = new Size(600, 480);
            form.FillLogInfo(info);
            form.ShowDialog();
        }

        public NLogDetailForm()
        {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(NLogDetailForm));
