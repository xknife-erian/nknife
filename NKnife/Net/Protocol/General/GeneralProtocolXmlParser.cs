...
namespace NKnife.Net.Protocol.General
{
    public class GeneralProtocolXmlParser : IProtocolParser
    {
        ...
        /// <returns></returns>
        public virtual IProtocolContent Execute(string data, string family, string command)
        {
            if (string.IsNullOrWhiteSpace(data))
            {
                return null;
            }
            IProtocolContent content = Protocols.GetBlankContent(family, command);
