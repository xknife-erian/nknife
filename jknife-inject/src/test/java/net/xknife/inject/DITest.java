...
import net.xknife.inject.MockDI;
import net.xknife.lang.interfaces.ITranslateable;
...
public class DITest
{
	...
	public void testClear()
	{
		...
		Assert.assertEquals(3, MockDI.getModules().size());
		DI.clear();
		Assert.assertEquals(0, MockDI.getModules().size());
		Assert.assertNull(MockDI.getInject());
	}
	...
	public void testGetInstanceClassOfT()
	{
		...
		Assert.assertTrue(tr instanceof FakeTranslateImpl);
	}
