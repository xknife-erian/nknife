...
namespace NKnife.Win.Forms.ExceptionUI
{
    ...
    /// </summary>
    public sealed partial class ExceptionDialog : System.Windows.Forms.Form
    {
        ...
        private InformationPanel InformationPanel => _informationPanel;

        public Image InformationPanelImage
        {
            get => InformationPanel.Image;
        ...
        /// <param name="ex"></param>
        public static void ShowDialog(System.Windows.Forms.Form owner, Exception ex)
        {
        ...
        private delegate void ShowDialogDelegate(System.Windows.Forms.Form owner, Exception ex);
