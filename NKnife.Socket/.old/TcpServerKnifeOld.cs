...
namespace SocketKnife
{
    ...
    ///     轻量Socket服务器端。
    /// </summary>
    public class TcpServerKnifeOld : IDisposable, ISocketServer
    {
        #region 成员变量
        ...
        public TcpServerKnifeOld SetProtocolFactory(ProtocolFactory protocolFactory)
        {
