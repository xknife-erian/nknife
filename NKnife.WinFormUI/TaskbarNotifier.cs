...
namespace NKnife.Draws.WinForm
{
    ...
    public class TaskbarNotifier : System.Windows.Forms.Form
    {
        ...
        protected Font normalTitleFont = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        protected Font hoverTitleFont = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        protected Font normalContentFont = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        protected Font hoverContentFont = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        ...
        /// <summary>获取或设置内容文本的横向对齐方式
        /// </summary>
        /// <value>The content align.</value>
        public StringAlignment ContentAlign
        {
        ...
        private StringAlignment contentAlign = StringAlignment.Center;
        ...
        public void Show(string strTitle, string strContent, int nTimeToShow, int nTimeToStay, int nTimeToHide)
        {
            ...
            if (nTimeToShow > 10)
            {
                nEvents = System.Math.Min((nTimeToShow / 10), BackgroundBitmap.Height);
            ...
            if (nTimeToHide > 10)
            {
                nEvents = System.Math.Min((nTimeToHide / 10), BackgroundBitmap.Height);
        ...
        protected void DrawText(Graphics grfx)
        {
            ...
            {
                StringFormat sf = new StringFormat();
                sf.Alignment = this.ContentAlign;
                sf.LineAlignment = StringAlignment.Center;
        ...
        protected void CalculateMouseRectangles()
        {
            ...
            // 根据正文的文本对齐方向计算正文的矩形的大小
            int realRectX = ContentRectangle.X;
            switch (this.ContentAlign)
            {
                case StringAlignment.Center:
                    realRectX = (ContentRectangle.Width - (int)sizefContent.Width) / 2 + ContentRectangle.Left;
                    break;
                case StringAlignment.Far:
                    realRectX = realRectX + (ContentRectangle.Width - (int)sizefContent.Width);
                    break;
            ...
            {
                RealContentRectangle = new Rectangle(
                    realRectX, 
                    ContentRectangle.Top, 
                    (int)sizefContent.Width, 
